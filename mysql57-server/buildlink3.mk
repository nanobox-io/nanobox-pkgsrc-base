...
BUILDLINK_API_DEPENDS.mysql-server+=	mysql-server>=5.7.10
BUILDLINK_ABI_DEPENDS.mysql-server?=	mysql-server>=5.7.10
BUILDLINK_PKGSRCDIR.mysql-server?=	../../base/mysql57-server
