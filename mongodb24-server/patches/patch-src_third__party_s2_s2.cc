...
--- src/third_party/s2/s2.cc.orig	2013-10-31 14:15:50.000000000 +0000
+++ src/third_party/s2/s2.cc
@@ -698,9 +698,9 @@ S2::LengthMetric const S2::kAvgAngleSpan
...
+    S2_PROJECTION == S2_LINEAR_PROJECTION ? sqrt((double)2. / 3) :             // 0.816
