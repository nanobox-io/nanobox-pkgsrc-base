...
PHP_EXTENSION_LIST= dom filter hash json mbstring pdo session xml \
	...
	xsl zip zlib \
	amqp apcu apfd apm blackfire gender geoip gnupg http ioncube_loader json_post lzf memcached mogilefs mongodb newrelic oauth phalcon rar readline redis sodium ssh2 stats timezonedb trader xdebug yaml
