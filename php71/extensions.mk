...
PHP_EXTENSION_LIST= dom filter hash json mbstring pdo session xml \
	...
	xsl zip zlib \
	amqp apcu apfd apm blackfire gender geoip gnupg http json_post libsodium lzf memcache memcached mogilefs mongodb newrelic oauth phalcon readline redis ssh2 stats timezonedb xdebug
