...
PKG_SUPPORTED_OPTIONS=	dav flv gtools inet6 luajit mail-proxy memcache naxsi \
			...
			status nginx-autodetect-cflags spdy echo \
			set-misc headers-more array-var encrypted-session \
			form-input passenger
PKG_SUGGESTED_OPTIONS:= ${PKG_SUPPORTED_OPTIONS}
PKG_SUPPORTED_OPTIONS+= debug upload
...
DEPENDS+=		${RUBY_PKGPREFIX}-passenger-[0-9]*:../../base/ruby-passenger

CONFIGURE_ARGS+=	--add-module=${WRKDIR}/passenger/ext/nginx

.include "../../base/ruby-passenger/inplace.mk"
