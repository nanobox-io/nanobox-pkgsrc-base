# $NetBSD: rubyversion.mk,v 1.138.2.3 2015/04/26 08:47:12 tron Exp $
#
...
#
#		Possible values: 19 20 21 22 23
#		Default: 23
#
# RUBY_BUILD_RDOC
...
#	major, minor and teeny version.
#
#		Example values: RUBY19 RUBY20 RUBY21
#
# RUBY_ABI_VERSION
#	Ruby's ABI version.
#
...
JRUBY16_VERSION=	1.6.8
JRUBY17_VERSION=	1.7.22
JRUBY90_VERSION=	9.0.3.0

# patch
RUBY19_PATCHLEVEL=	p551
RUBY20_PATCHLEVEL=	p648
#RUBY21_PATCHLEVEL=	p336
#RUBY22_PATCHLEVEL=	p95

# current API compatible version; used for version of shared library
RUBY19_API_VERSION=	1.9.1
RUBY20_API_VERSION=	2.0.0
RUBY21_API_VERSION=	2.1.0
RUBY22_API_VERSION=	2.2.0
RUBY23_API_VERSION=	2.3.0
RUBY24_API_VERSION=	2.4.0
RUBY25_API_VERSION=	2.5.0
JRUBY16_API_VERSION=	1.6.8
JRUBY17_API_VERSION=	1.7.22
JRUBY90_API_VERSION=	9.0.3.0
...
#
RUBY_VERSION_DEFAULT?=   ruby20

RUBY_VERSION_SUPPORTED?= ruby20 ruby19 ruby21 ruby22 ruby23 ruby24 ruby25 jruby16 jruby17 jruby90
...
.elif ${RUBY_VER} == "ruby20"
RUBY_VERSION=		${RUBY20_VERSION}
RUBY_VERSION_NEXT=	2.1.0
RUBY_PATCHLEVEL=	${RUBY20_PATCHLEVEL}
RUBY_VERSION_FULL=	${RUBY_VERSION}${RUBY_PATCHLEVEL}
RUBY_ABI_VERSION=	${RUBY_VERSION}
RUBY_API_VERSION=       ${RUBY20_API_VERSION}
RUBY_PKGPREFIX=		${RUBY_NAME}20
...
.elif ${RUBY_VER} == "ruby21"
RUBY_VERSION=		${RUBY21_VERSION}
RUBY_VERSION_NEXT=	2.2.0
RUBY_VERSION_FULL=	${RUBY_VERSION}
RUBY_ABI_VERSION=	${RUBY_VERSION}
RUBY_API_VERSION=       ${RUBY21_API_VERSION}
RUBY_PKGPREFIX=		${RUBY_NAME}21
...
.elif ${RUBY_VER} == "ruby22"
RUBY_VERSION=		${RUBY22_VERSION}
RUBY_VERSION_NEXT=	2.3.0
RUBY_VERSION_FULL=	${RUBY_VERSION}
RUBY_ABI_VERSION=	${RUBY_VERSION}
RUBY_API_VERSION=       ${RUBY22_API_VERSION}
RUBY_PKGPREFIX=		${RUBY_NAME}22
...
.elif ${RUBY_VER} == "ruby23"
RUBY_VERSION=		${RUBY23_VERSION}
RUBY_VERSION_NEXT=	2.4.0
RUBY_VERSION_FULL=	${RUBY_VERSION}
RUBY_ABI_VERSION=	${RUBY_VERSION}
RUBY_API_VERSION=       ${RUBY23_API_VERSION}
RUBY_PKGPREFIX=		${RUBY_NAME}23
...
.elif ${RUBY_VER} == "ruby24"
RUBY_VERSION=           ${RUBY24_VERSION}
RUBY_VERSION_NEXT=	2.5.0
RUBY_VERSION_FULL=      ${RUBY_VERSION}
RUBY_ABI_VERSION=       ${RUBY_VERSION}
RUBY_API_VERSION=       ${RUBY24_API_VERSION}
RUBY_PKGPREFIX=         ${RUBY_NAME}24
...
.elif ${RUBY_VER} == "ruby25"
RUBY_VERSION=           ${RUBY25_VERSION}
RUBY_VERSION_NEXT=	2.6.0
RUBY_VERSION_FULL=      ${RUBY_VERSION}
RUBY_ABI_VERSION=       ${RUBY_VERSION}
RUBY_API_VERSION=       ${RUBY25_API_VERSION}
RUBY_PKGPREFIX=         ${RUBY_NAME}25
...
.elif ${RUBY_VER} == "jruby16"
RUBY_VERSION=		${JRUBY16_VERSION}
RUBY_VERSION_NEXT=	1.7.0
RUBY_VERSION_FULL=	${RUBY_VERSION}
RUBY_ABI_VERSION=	${RUBY_VERSION}
RUBY_PKGPREFIX=		j${RUBY_NAME}16
RUBY_BASE=			jruby
RUBY_GEM_BASE=		share/jruby-${RUBY_VERSION}/lib/ruby/gems
GEM_HOME=			${RUBY_GEM_BASE}/1.8

RUBY_GEMS_VERSION=	1.8.24
RUBY_RDOC_VERSION=	4.2.0
RUBY_RAKE_VERSION=	0.8.7
RUBY_JSON_VERSION=	1.8.3


.elif ${RUBY_VER} == "jruby17"
RUBY_VERSION=		${JRUBY17_VERSION}
RUBY_VERSION_NEXT=	1.8.0
RUBY_VERSION_FULL=	${RUBY_VERSION}
RUBY_ABI_VERSION=	${RUBY_VERSION}
RUBY_PKGPREFIX=		j${RUBY_NAME}17
RUBY_BASE=			jruby
RUBY_GEM_BASE=		share/jruby-${RUBY_VERSION}/lib/ruby/gems
GEM_HOME=			${RUBY_GEM_BASE}/shared
...
.elif ${RUBY_VER} == "jruby90"
RUBY_VERSION=		${JRUBY90_VERSION}
RUBY_VERSION_NEXT=	10.0.0
RUBY_VERSION_FULL=	${RUBY_VERSION}
RUBY_ABI_VERSION=	${RUBY_VERSION}
RUBY_PKGPREFIX=		j${RUBY_NAME}90
RUBY_BASE=			jruby
RUBY_GEM_BASE=		share/jruby-${RUBY_VERSION}/lib/ruby/gems
GEM_HOME=			${RUBY_GEM_BASE}/shared
...
#RUBY_PATCHLEVEL=	${${RUBY_VER}_PATCHLEVEL}
#RUBY_API_VERSION=	${${RUBY_VER}_API_VERSION}
.endif
...
#	with ${RUBY_NAME}; "RUBY19", "RUBY20" and so on.
#
...
.if ${RUBY_VER} == "ruby19" || ${RUBY_VER} == "ruby20"
...
RUBY_SHLIB?=		.${RUBY_SLEXT}.${RUBY_SHLIBVER}
RUBY_SHLIBALIAS?=	@comment
RUBY_STATICLIB?=	-static.a

.if ${OPSYS} == "NetBSD" || ${OPSYS} == "Interix"
RUBY_SHLIBVER=		${_RUBY_API_MAJOR}.${_RUBY_API_MINOR}
_RUBY_SHLIBALIAS=	.${RUBY_SLEXT}.${_RUBY_API_MAJOR}
...
.endif
.elif ${OPSYS} == "Darwin"
RUBY_SHLIB=		.${RUBY_SHLIBVER}.${RUBY_SLEXT}
_RUBY_SHLIBALIAS=	.${_RUBY_VER_MAJOR}.${_RUBY_VER_MINOR}.${RUBY_SLEXT}
RUBY_STATICLIB=		.${RUBY_API_VERSION}-static.a
.elif ${OPSYS} == "Linux"
_RUBY_SHLIBALIAS=	.${RUBY_SLEXT}.${_RUBY_VER_MAJOR}.${_RUBY_VER_MINOR}
.elif ${OPSYS} == "SunOS"
RUBY_SHLIBVER=		${_RUBY_VER_MAJOR}
 _RUBY_SHLIBALIAS=	.${RUBY_SLEXT}.${_RUBY_VER_MAJOR}.${_RUBY_VER_MINOR}.${_RUBY_API_MINOR}
.elif ${OPSYS} == "Cygwin"
RUBY_SHLIB=		${_RUBY_API_MAJOR}${_RUBY_API_MINOR}.dll.a
RUBY_SHLIBALIAS=	bin/cygruby${_RUBY_API_MAJOR}${_RUBY_API_MINOR}.dll
RUBY_STATICLIB=		${_RUBY_API_MAJOR}${_RUBY_API_MINOR}-static.a
.endif
...
FILES_SUBST+=		RUBY=${RUBY:Q} RUBY_NAME=${RUBY_NAME:Q} \
			...
			RUBY_VER=${RUBY_VER:S/j?ruby//:Q} \
			${PLIST_RUBY_DIRS}

MESSAGE_SUBST+=		RUBY="${RUBY}" RUBY_VER="${RUBY_VER:S/j?ruby//}" \
			RUBY_VERSION="${RUBY_VERSION}" \
			RUBY_PKGPREFIX="${RUBY_PKGPREFIX}" \
			RUBY_SUFFIX=${RUBY_SUFFIX} \
			${PLIST_RUBY_DIRS:S,DIR="${PREFIX}/,DIR=",}

PLIST_SUBST+=		RUBY=${RUBY:Q} RUBY_VER=${RUBY_VER:S/j?ruby//:Q} \
			RUBY_PKGPREFIX=${RUBY_PKGPREFIX} \
			RUBY_SUFFIX=${RUBY_SUFFIX} \
...
PRINT_PLIST_AWK+=	/lib\/libruby${RUBY_VER:S/j?ruby//}\.${RUBY_SLEXT}/ \
			{ sub(/${RUBY_VER:S/j?ruby//}\.${RUBY_SLEXT}$$/, \
			"$${RUBY_VER:S/j?ruby//}.$${RUBY_SLEXT}"); }
