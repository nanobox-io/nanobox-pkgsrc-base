...
PHP_EXTENSION_LIST= dom filter hash json mbstring pdo session xml \
	...
	xsl zip zlib \
	amqp apcu apfd apm gender geoip http imagick json_post lzf memcached mogilefs mongodb newrelic oauth readline redis ssh2 stats stomp timezonedb xdebug