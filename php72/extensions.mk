...
PHP_EXTENSION_LIST= dom filter hash json mbstring pdo session xml \
	...
	xsl zip zlib \
	amqp apcu apfd apm blackfire gender geoip gnupg http json_post lzf memcached mogilefs mongodb oauth phalcon rar readline redis sodium ssh2 stats timezonedb trader
