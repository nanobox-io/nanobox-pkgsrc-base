...
PHP_EXTENSION_LIST= dom filter hash json mbstring pdo session xml \
	...
	gettext gmp iconv imap intl ldap mysqli opcache \
	...
	xsl zip zlib \
	amqp apcu apfd apm blackfire gender geoip gnupg http imagick json_post lzf memcache memcached mogilefs mongodb oauth phalcon rar readline redis sodium ssh2 stats stomp timezonedb trader yaml
