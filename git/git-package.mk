...
_GIT_DISTFILE.${repo}=  ${PKGBASE}-${GIT_MODULE.${repo}}-${GIT_BRANCH.${repo}}-${_GIT_PKGVERSION}.tar.gz
.  elif defined(GIT_REVISION.${repo})
_GIT_FLAG.${repo}=	${GIT_REVISION.${repo}}
_GIT_DISTFILE.${repo}=  ${PKGBASE}-${GIT_MODULE.${repo}}-${GIT_REVISION.${repo}}.tar.gz
.  elif defined(GIT_TAG.${repo})
_GIT_FLAG.${repo}=	tags/${GIT_TAG.${repo}}
_GIT_PKGVERSION=	# none
_GIT_DISTFILE.${repo}=  ${PKGBASE}-${GIT_MODULE.${repo}}-${GIT_TAG.${repo}}.tar.gz
.  else
...
.for _repo_ in ${GIT_REPOSITORIES}
	if [ -f ${_GIT_DISTDIR}/${_GIT_DISTFILE.${_repo_}:Q} ]; then ${RM} ${_GIT_DISTDIR}/${_GIT_DISTFILE.${_repo_}:Q}; fi
.endfor
