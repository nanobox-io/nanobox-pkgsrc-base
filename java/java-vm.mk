...
_JAVA_PKGBASE.sun-jdk8=		sun-jre8
...
_JDK_PKGSRCDIR=		../../base/sun-jdk7
_JRE_PKGSRCDIR=		../../base/sun-jdk7
_JAVA_HOME_DEFAULT=	${LOCALBASE}/java/sun-7
UNLIMIT_RESOURCES+=	datasize
.elif ${_PKG_JVM} == "sun-jdk8"
_JDK_PKGSRCDIR=		../../base/sun-jdk8
_JRE_PKGSRCDIR=		../../base/sun-jdk8
