...
PHP_EXTENSION_LIST= dom filter hash json mbstring pdo session xml \
	...
	xsl zip zlib \
	amqp apcu apfd apm blackfire gender geoip gnupg htscanner http ioncube_loader \
	json_post libsodium lzf magickwand memcache memcached mogilefs mongo mongodb \
	ncurses newrelic newt oauth phalcon phpwkhtmltox radius rar readline \
	redis sphinx ssh2 stats stomp svn timezonedb trader txforward uploadprogress \
	xcache xdebug yaml 
