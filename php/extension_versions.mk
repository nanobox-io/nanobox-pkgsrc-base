...
.if ${_PHP_VERSION} == "70"
PHP_EXTENSION_VERSION.http=		3.0.1			# https://pecl.php.net/package/pecl_http
.else
PHP_EXTENSION_VERSION.http=		2.5.6			# https://pecl.php.net/package/pecl_http
.endif
PHP_EXTENSION_VERSION.iconv=		${PHP_BASE_VERS}
.if ${_PHP_VERSION} == "70"
PHP_EXTENSION_VERSION.igbinary=		1.2.2			# https://pecl.php.net/package/igbinary
.else
...
.if ${_PHP_VERSION} == "70"
PHP_EXTENSION_VERSION.memcached=	3.0.0			# https://pecl.php.net/package/memcached
.else
